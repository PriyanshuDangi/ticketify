...
@genType
and entities = {
    @as("Event") event: entityStoreOperations<Entities.Event.t>,
    @as("PlatformFeeWithdrawal") platformFeeWithdrawal: entityStoreOperations<Entities.PlatformFeeWithdrawal.t>,
    @as("RevenueWithdrawal") revenueWithdrawal: entityStoreOperations<Entities.RevenueWithdrawal.t>,
    @as("TicketPurchase") ticketPurchase: entityStoreOperations<Entities.TicketPurchase.t>,
  }
  ...
  let entities = {
      event: {
        makeStoreOperatorEntity(
          ...
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Event)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Event.t,
            >
      ...
      platformFeeWithdrawal: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.PlatformFeeWithdrawal)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.PlatformFeeWithdrawal.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      revenueWithdrawal: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.RevenueWithdrawal)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.RevenueWithdrawal.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      ticketPurchase: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.TicketPurchase)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.TicketPurchase.t,
            >
          ),
          ~getKey=({id}) => id,
        )
