    ...
    let contracts = Js.Dict.fromArray([
      (
        "Ticketify",
        {
          ...
          addresses: [
            "0x1Cc7FA86240F105aa1F1fa9F795f9530c881b12E",
          ],
          events: [
            Types.Ticketify.EventCreated.name,
            Types.Ticketify.TicketPurchased.name,
            Types.Ticketify.RevenueWithdrawn.name,
            Types.Ticketify.PlatformFeesWithdrawn.name,
          ],
        }
      ),
    ])
